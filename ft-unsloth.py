...
def load_unsloth_model(args):
    ...
    os.environ['UNSLOTH_RETURN_LOGITS'] = '1'  # workaround because SFTTrainer() needs logits and unsloth wants to un sloth
    ...
    model, tokenizer = FastLanguageModel.from_pretrained(
        ...
        max_seq_length=1120,     #we need a long context dataset for qwens 32768 - but we don't have one, 1119 is max seq in our dataset.
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        save_total_limit=4,  # might be redundant
